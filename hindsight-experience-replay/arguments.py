...
def get_args():
    ...
    parser.add_argument('--lr-decoder', type=float, default=0.001, help='the learning rate of the decoder')
    parser.add_argument('--lr-encoder', type=float, default=0.001, help='the learning rate of the encoder')
